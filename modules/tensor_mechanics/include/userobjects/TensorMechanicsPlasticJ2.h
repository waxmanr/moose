...
class TensorMechanicsPlasticJ2 : public TensorMechanicsPlasticModel
{
 ...
 protected:
   ...
   */
  Real yieldFunction(const RankTwoTensor & stress, const std::vector<Real> & intnl) const;
   ...
   */
  RankTwoTensor dyieldFunction_dstress(const RankTwoTensor & stress, const std::vector<Real> & intnl) const;
   ...
   */
  std::vector<Real> dyieldFunction_dintnl(const RankTwoTensor & stress, const std::vector<Real> & intnl) const;
   ...
   */
  RankTwoTensor flowPotential(const RankTwoTensor & stress, const std::vector<Real> & intnl) const;
   ...
   */
  RankFourTensor dflowPotential_dstress(const RankTwoTensor & stress, const std::vector<Real> & intnl) const;
